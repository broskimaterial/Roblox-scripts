...
task.defer(function()
   ...
   pcall(function()
      for _, v in ipairs(game:GetService("CoreGui"):GetChildren()) do
         if v:IsA("ScreenGui") and (v.Name:find("Rayfield") or v.Name:find("UTG") or v:FindFirstChild("Main", true)) then
            v.Parent = game:GetService("Players").LocalPlayer:WaitForChild("PlayerGui")
         end
      end
   end)
end)
